...
@CommandLine.Command(name = "generateTestData2", description = "Generate test data.")
public class GenerateTestData2 implements Callable<Integer> {
  ...
  public Integer call() throws Exception {
    final Collection<File> jsonInputFiles =
        FileUtils.listFiles(inputDirectory, new String[] {"json"}, true);
