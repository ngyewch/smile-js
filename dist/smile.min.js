...
function(){var b=this.readSafeBinary(),a=0,f;for(f=0;f<b.length;f++)a=256*a+b[f];return a};b.DecoderStream.prototype.readBigDecimal=function(){var b=this.readSignedVint();return this.readBigInt()*Math.pow(10,b)};b.DecoderStream.prototype.readLongString=function(){for(var b=new Uint8Array,a;;){a=this._inputStream.read();if(252===a)break;b[b.length]=a}return b};b.DecoderStream.prototype.readLongAscii=function(){return b.Decoder.decodeAscii(this.readLongString())};b.DecoderStream.prototype.readLongUtf8=
